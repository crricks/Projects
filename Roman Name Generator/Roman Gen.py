...
#             font_size = 55
#             )
#         inputs.add_widget(self.label)
#         inputs.add_widget(self.txt_input)
#         self.enter = Button(
#             text = 'Enter',
#             pos_hint={'center_x':0.5, 'center_y': 0.5}
#             )
#         self.enter.bind(on_press=self.roman_calculation(self.txt_input.text))
#         main_layout.add_widget(inputs)
#         main_layout.add_widget(self.enter)
#         return main_layout
#     
#     def roman_calculation(self, *args):
#         self.name = str(args)
...
#                 added = random.choice('v', 'm', 'n', 'l', 'ns', 'rp')
#             roman_word = word + added + self.rom_ending()
#             self.roman_name.append(roman_word)
#         self.roman_name = ' '.join(self.roman_name)
#     
#     def rom_ending(self):
#         roman_endings = open('latin_endings.txt', 'r')
#         ending_list = []
#         for word in roman_endings: 
#             ending_list.append(word)
#         self.end = random.choice(ending_list)
# =============================================================================
